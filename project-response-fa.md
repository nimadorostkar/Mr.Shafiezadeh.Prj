...
آنچه در ادامه می‌آید بخشی پاسخ‌نامه است، بخشی پیشنهاد فنی، و بخشی همان گفت‌وگویی که اگر از پیش با هم کار می‌کردیم، سر یک فنجان قهوه داشتیم.
...
هر بخش از این سند را که بخواهید، با کمال میل به یک نقشه‌ی عملیاتیِ مشخص برای فاز ۰ تبدیل می‌کنم؛ هر وقت آماده بودید.
